...
<!-- ===========================================================
     ...
     Specialty patterns:
       ...
       options            → recommend-one-of-two with KPI grid per side
...
<p class="step-desc">Voluptatem sequi nesciunt qui dolorem.</p>
...
## Both options reach the same revenue target — they differ in capital intensity, speed, and organisational risk.
...
<p class="lead">Lorem ipsum dolor sit amet — invest in a dedicated platform team and own the customer relationship end-to-end.</p>
...
<p class="lead">Sed ut perspiciatis unde omnis — license the platform from an established vendor and focus on integration and channels.</p>
